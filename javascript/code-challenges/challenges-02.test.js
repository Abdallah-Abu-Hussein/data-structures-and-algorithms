...
const raisedToTheThird = (arr) => {
  // Solution code here...
  let newArray = [];
  arr.forEach(val => newArray.push(Math.pow(val, 3)));
  return newArray;
};
...
const addOne = (arr) => {
  // Solution code here...
  let newArray = arr.map(val => val+=1); return newArray;
...
const addQuestion = (arr) => {
  // Solution code here...
  let newArray = arr.map(val => val+'?'); return newArray;
};
...
const mapTwoToThe = (arr) => {
  // Solution code here...
  let newArray = arr.map(val => Math.pow(2, val)); return newArray;
};
